...
#contact
def contact():
    mess._show(title="Contact Us",message="Reach out to us at: attendit1603@gmail.com")

#about
def about():
    mess._show(title="About",message="This is a facial recognition based Attendance System. For a new registration, enter your institution's ID number followed by your name. Select the option of 'Take Images' and click on 'Save Profile'. For taking attendanace, click on the 'Take Attendance' button.")
...
def check_haarcascadefile():
    ...
    if exists:
        ...
        mess._show(title='File Missing', message='Please download the haarcascade file to proceed.')
        window.destroy()
...
#GUI using Tkinter
window = tkinter.Tk()
window.title("Attendit: The Attendance Tool For Everyone")
window.geometry("1280x720")
window.resizable(True,True)
window.configure(background='#0C1228')
...
#main window
message3 = tkinter.Label(window, text="ATTENDIT" ,fg="#F5A425",bg="#0C1228" ,width=60 ,height=1,font=('monserrat,sans-serif', 29, ' bold '))
message3.place(x=10, y=10,relwidth=1)

#frames
frame1 = tkinter.Frame(window, bg="#162238")
frame1.place(relx=0.11, rely=0.15, relwidth=0.39, relheight=0.80)

frame2 = tkinter.Frame(window, bg="#162238")
frame2.place(relx=0.51, rely=0.15, relwidth=0.39, relheight=0.80)

#frame_headder
fr_head1 = tkinter.Label(frame1, text="NEW REGISTRATION", fg="#F5A425",bg="#162238" ,font=('times', 17, ' bold ') )
fr_head1.place(x=0,y=0,relwidth=1)

fr_head2 = tkinter.Label(frame2, text="MARK ATTENDANCE", fg="#F5A425",bg="#162238" ,font=('times', 17, ' bold ') )
fr_head2.place(x=0,y=0,relwidth=1)

#registration frame
lbl = tkinter.Label(frame1, text="Enter ID",width=20  ,height=1  ,fg="white"  ,bg="#162238" ,font=('times', 17, ' bold ') )
lbl.place(x=0, y=55)

txt = tkinter.Entry(frame1,width=32 ,fg="white",bg="#162238",highlightcolor="white",highlightthickness=3,font=('times', 15, ' bold '))
txt.place(x=55, y=88,relwidth=0.75)

lbl2 = tkinter.Label(frame1, text="Enter Name",width=20  ,fg="white"  ,bg="#162238" ,font=('times', 17, ' bold '))
lbl2.place(x=0, y=140)

txt2 = tkinter.Entry(frame1,width=32 ,fg="white",bg="#162238",highlightcolor="white",highlightthickness=3,font=('times', 15, ' bold ')  )
txt2.place(x=55, y=173,relwidth=0.75)

message0=tkinter.Label(frame1,text="      Steps to follow:",bg="#162238" ,fg="#F5A425"  ,width=39 ,height=1,font=('times', 16, ' bold '))
message0.place(x=7,y=275)

message1 = tkinter.Label(frame1, text="Step 1)  Take Images      Step 2)  Save Profile" ,bg="#162238" ,fg="#F5A425"  ,width=39 ,height=1, activebackground = "yellow" ,font=('times', 15, ' bold '))
message1.place(x=7, y=300)

message = tkinter.Label(frame1, text="" ,bg="#162238" ,fg="#F5A425"  ,width=39,height=1, activebackground = "white" ,font=('times', 16, ' bold '))
message.place(x=7, y=500)
#Attendance frame
lbl3 = tkinter.Label(frame2, text="Attendance Chart",width=20  ,fg="white"  ,bg="#162238"  ,height=1 ,font=('times', 17, ' bold '))
...
clearButton = tkinter.Button(frame1, text="Clear", command=clear, fg="white", bg="#F5A425", width=11, activebackground = "white", font=('times', 12, ' bold '))
clearButton.place(x=30, y=230,relwidth=0.89)

takeImg = tkinter.Button(frame1, text="Take Images", command=TakeImages, fg="white", bg="#F5A425", width=34, height=1, activebackground = "white", font=('times', 16, ' bold '))
takeImg.place(x=30, y=350,relwidth=0.89)

trainImg = tkinter.Button(frame1, text="Save Profile", command=psw, fg="white", bg="#F5A425", width=34, height=1, activebackground = "white", font=('times', 16, ' bold '))
trainImg.place(x=30, y=430,relwidth=0.89)

trackImg = tkinter.Button(frame2, text="Take Attendance", command=TrackImages, fg="white", bg="#F5A425", height=1, activebackground = "white" ,font=('times', 16, ' bold '))
trackImg.place(x=30,y=60,relwidth=0.89)

quitWindow = tkinter.Button(frame2, text="Quit", command=window.destroy, fg="white", bg="#F5A425", width=35, height=1, activebackground = "white", font=('times', 16, ' bold '))
